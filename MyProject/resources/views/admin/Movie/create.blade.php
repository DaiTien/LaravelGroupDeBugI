            ...
            <div class=row>
                <div class="col-8">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Tên phim" name="name" class="form-control" value="{{old('name')}}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Đạo diễn" name="director" class="form-control" value="{{old('director')}}"/>
                            @error('director')
                            <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Diễn viên chính" name="actors" class="form-control" value="{{old('actors')}}"/>
                            @error('actors')
                            <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Thời lượng" name="duration" class="form-control" value="{{old('duration')}}"/>
                            @error('duration')
                            <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Năm sản xuất" name="year_manufacture" class="form-control" value="{{old('year_manufacture')}}"/>
            ...
            <div class=row>
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" placeholder="Mô tả" name="description" class="form-control" rows="3">{{old('description')}}</textarea>
                            @error('description')
                            <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" placeholder="Nội dung" name="contents" id="summernote" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-12">
