    ...
    <div class="card mb-4">
        ...
        <form method="POST">
            ...
            <div class="form-group text-center">
                <a href="javascript:void(0)" onclick="disableSeat()" id="btnDisable" class="btn btn-primary" style="pointer-events: none">{{__('TextDisable')}}</a>
                <a href="javascript:void(0)" onclick="enableSeat()" id="btnEnable" class="btn btn-primary" style="pointer-events: none">{{__('TextEnable')}}</a>
            </div>
        </form>
    </div>
    <script>
