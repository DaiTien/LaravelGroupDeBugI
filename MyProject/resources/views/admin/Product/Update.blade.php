...
<div class="Page breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{__('UpdateProduct')}}</li>
    </ol>
</div>
@endsection
@section('content')
<div class="m-auto">
    <h3 class="text-center text-uppercase">{{__('TitleFormUpdateProduct')}}</h3>
    <form action="{{route('update-product')}}" method="POST" style="width:95%" enctype="multipart/form-data">
        @csrf
        <div class=row>
            <div class="col-8">
                <div class="form-group row" hidden>
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="id" name="id" value="{{$product->id}}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3">Name</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="name" value="{{$product->name}}" name="name" class="form-control" onchange="fncSlug(this.value)">
                        @error('name')
                    ...
                    <div class="col-sm-9">
                        <div id=upload>
                            ...
                            <button type="button" class="btn-change" onclick="clickavatar1()">
                                <img id="imgPreview1" src="../../{{ $product->image }}" alt="" style="max-width: 100%; height: auto">
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class=row>
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" placeholder="introduce" name="introduce" class="form-control" rows="3">{{$product->introduce}}</textarea>
                        @error('introduce')
                        <span class="text-danger font-weight-bold">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" placeholder="detail" name="detail" id="summernote" class="form-control">{{$product->detail}}</textarea>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" id="CurrencyInput" onkeypress="return valid_numbers(event)" placeholder="price" name="price" value="{{$product->price}}" class="form-control">
                        @error('price')
                        <span class="text-danger font-weight-bold">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="col-12">
                <div class="form-group row" hidden>
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="txtSlug" placeholder="slug" value="{{$product->slug}}" name="slug" class="form-control">
                    </div>
                </div>
            </div>
            <div class="col-12">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" value="0" name="active" {{$product->active==0?"checked":""}}>Ẩn
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" value="1" name="active" {{$product->active==1?"checked":""}}>Hiện
                            </label>
                        </div>
                    </div>
                </div>
