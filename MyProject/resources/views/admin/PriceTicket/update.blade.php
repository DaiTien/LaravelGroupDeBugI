            ...
            <div class=row>
                ...
                <div class="col-8 mx-auto">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Loại vé" name="name" class="form-control" value="{{old('name', $price->name)}}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Giá vé" name="price" class="form-control" value="{{old('price', number_format($price->price,0,',',','))}}" id="CurrencyInput" onkeypress="return valid_numbers(event)"  />
                            @error('price')
                            <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
