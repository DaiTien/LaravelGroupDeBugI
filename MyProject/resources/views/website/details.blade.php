	...
	<section class="section section--head section--head-fixed section--gradient section--details-bg">
		<div class="section__bg" data-bg="website/img/details.jpg"></div>
		<div class="container">
			<!-- article -->
			<div class="article">
				<div class="row">
					...
					<div class="col-12 col-xl-8">
						...
						<div class="article__actions article__actions--details">
							<div class="article__download">
								...
								<a class="btn btn-primary" href="./pricing.html">mua vé <img src="https://img.icons8.com/nolan/30/fast-cart.png"/></a>
							</div>
								...
								<div class="section__series owl-carousel" id="series">
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/1.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/2.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/3.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/4.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/5.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="website/img/series/6.jpg" alt="">
											<span>
									...
									<ul class="comments__list">
										<li class="comments__item">
											<div class="comments__autor">
												<img class="comments__avatar" src="website/img/avatar.svg" alt="">
									...
									<ul class="reviews__list">
										<li class="reviews__item">
											<div class="reviews__autor">
												<img class="reviews__avatar" src="website/img/avatar.svg" alt="">
