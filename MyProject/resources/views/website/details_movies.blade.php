                    ...
                    <div class="row">
                        <div class="col-dt-8 col-tl-12 col-mb-12">
                            <div class="pricing-box hightlight">
                                <div class="pricing-box-content text-left content-details__movie">
                                    <h2 class="title-details__movie">{{ $movie->name }}</h2>
                                    <?php
                                    echo $movie->content;
                                    ?>
                                ...
                                <div class="pricing-box-action">
                                    <video class="youtube-video" data-yt2html5="{{ $movie->video }}" controls
                                        autoplay></video>
                                    <div class="article__actions article__actions--details">
                                        ...
                                        <a class="article__favorites"
                                            ...
                                            <svg height="512pt" viewBox="0 -31 512.00026 512" width="512pt"
                        ...
                        <div class="col-dt-4 col-tl-12 col-mb-12">
                            <div class="pricing-box pricing-box__image hightlight">
                                <a href="javascipt:void(0)" class="movie-item movie-item--image">
